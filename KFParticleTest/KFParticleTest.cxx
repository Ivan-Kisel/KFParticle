...
ClassImp(KFParticleTest)
  ...
  std::ostream&
  operator<<(std::ostream& os, const KFParticleBase& particle)
{
  ...
  for (Int_t i = 0; i < 8; i++) {
    if (i == 6)
      continue; // E
    if (i == 7 && particle.GetParameter(i) <= 0.0)
      continue; // S
  ...
  for (Int_t i = 8; i < 11; i++) {
    if (i == 9 && Mtp[i - 8] <= 0.0)
      continue; // t
    if (MtpErr[i - 8] > 0 && MtpErr[i - 8] < 1e10)
      os << " " << vn[i] << ": " << std::setw(8) << Mtp[i - 8] << " +/-" << std::setw(7) << MtpErr[i - 8];
    else
      os << " " << vn[i] << ": " << std::setw(8) << Mtp[i - 8];
  }
...
void KFParticleTest::RunTestSingle()
{
  ...
  std::cout << "Try different constructors" << std::endl
            << std::endl;
  std::cout << "1. Construction from Vertex" << std::endl
            << std::endl;
  KFPVertex vert;
  ...
  KFParticle p1(vert);
  std::cout << "Vertex Particle p1" << std::endl
            << "  " << p1 << std::endl;
  ...
  std::cout << std::endl
            << "2. Construction from Track" << std::endl
            << std::endl;
  ...
  std::cout << "Track Particle p2" << std::endl
            << "  " << p2 << std::endl;

  ///  *****************************************************************************************

  std::cout << std::endl
            << "3. Now we will create one more particle from track and call the construction from these 2 particles" << std::endl
            << std::endl;
  ...
  std::cout << "Track Particle p3 " << std::endl
            << "  " << p3 << std::endl;

  KFParticle p4(p2, p3);
  std::cout << "Particle p4(p2,p3)" << std::endl
            << "  " << p4 << std::endl;

  ///  *****************************************************************************************
  std::cout << std::endl
            << "4. Construction with constrained Mass or (and) vertex position values" << std::endl
            << std::endl;
  ...
  std::cout << "4.1 Construction with constrained Mass, without vertex hypothesis " << std::endl
            << std::endl;
  ...
  std::cout << "Dauthers" << std::endl
            ...
            << "Mass    " << Mass << std::endl;
  std::cout << "Particle K0" << std::endl
            << K0 << std::endl;
  K0.SetProductionVertex(pVertex);
  std::cout << " Add parent Vertex" << std::endl;
  std::cout << " K0 with vertex  " << K0 << std::endl;
  std::cout << std::endl
            << "4.2 Construction without constrained Mass, with vertex hypothesis " << std::endl
            << std::endl;
  ...
  std::cout << "Dauthers" << std::endl
            ...
            << "PV " << std::endl
            << "  " << pVertex << std::endl;
  std::cout << "K0_1" << std::endl
            << "  " << K0_1 << std::endl;
  std::cout << std::endl
            << "4.3 Construction with constrained Mass, with vertex hypothesis " << std::endl
            << std::endl;
  ...
  std::cout << "Dauthers" << std::endl
            ...
            << "  " << pVertex << std::endl
            << "Mass    " << Mass << std::endl;
  std::cout << "K0_2" << std::endl
            << "  " << K0_2 << std::endl;

  std::cout << std::endl
            << "4.4 Construction K0_3(p2,p3) without constrained Mass, without vertex hypothesis " << std::endl
            << std::endl;
  ///we assume p1 to be the vertex of the constructed particle, Mass to be the mass of the constructed particle
  KFParticle K0_3;
