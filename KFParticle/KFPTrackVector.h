...
class KFPTrackVector
{
 ...
 public:
...
#ifdef NonhomogeneousField
  const kfvector_float& FieldCoefficient(const int i) const
  {
    return fField[i];
  } ///< Returns constant reference to the magnetic field coefficient with index "i".
#endif
  ...
  {
    fField[iP][iTr] = value;
  } ///< Sets the "value" of the field coefficient "iP" of the track with index "iTr".
#endif
